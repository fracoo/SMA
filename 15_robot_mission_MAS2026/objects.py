...
WASTE_UNITS = {"green": 1, "yellow": 2, "red": 4}

class WasteAgent(mesa.Agent):
    def __init__(self, model, waste_type, original_count=None):
        super().__init__(model)
        self.waste_type = waste_type
        self.original_count = original_count if original_count is not None else WASTE_UNITS[waste_type]
